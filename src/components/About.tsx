      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              <img
                ...
                className="w-full max-w-md rounded-3xl shadow-2xl shadow-chocolate-900/40 object-cover h-[500px]"
              />
            </div>
            <div className="absolute -bottom-8 -right-4 lg:right-8 z-20">
              <img
                ...
                alt="Nos éclairs"
                className="w-48 h-48 sm:w-56 sm:h-56 rounded-2xl shadow-xl shadow-chocolate-900/40 object-cover border-4 border-white"
              />
            </div>
            {/* Decorative */}
          ...
          <div>
            ...
            <h2 className="font-poppins text-4xl sm:text-5xl font-bold text-chocolate-900 mt-3 mb-6 leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-cream-50 transition-all duration-300"
                >
