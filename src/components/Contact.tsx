        ...
        <div className="grid lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            {info.map((item) => (
              <div
                key={item.title}
                className="group flex items-start gap-3 sm:gap-4 p-4 sm:p-5 bg-white rounded-2xl hover:shadow-lg transition-all duration-300"
              >
                ...
                <div>
                  ...
                  {item.lines.map((line) => (
                    <p key={line} className="text-chocolate-500 text-xs sm:text-sm">
                      {line}
                    </p>
                  ))}
                </div>
          ...
          <div className="lg:col-span-3">
            ...
            >
              {submitted && (
                <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-2xl text-center font-medium text-sm animate-fadeIn">
