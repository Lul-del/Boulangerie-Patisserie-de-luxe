...
function commanderWhatsApp(product: { name: string; price: string }) {
  const message =
    ...
    `Merci !`;
  window.open(
    `https://wa.me/2290151928187?text=${encodeURIComponent(message)}`,
    "_blank",
    "noopener,noreferrer",
  );
}
...
const products: Product[] = [
  ...
  },
  {
    ...
    priceNum: 15500,
    description:
      "Coffret de macarons aux saveurs variées, coque légère et craquante",
    image: mac1,
    badge: null,
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/30461317/pexels-photo-30461317.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    badge: null,
  },
  {
    id: 11,
    ...
    image:
      "https://images.pexels.com/photos/30700723/pexels-photo-30700723.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    badge: "Nouveau",
  },
  {
    id: 12,
    ...
    priceNum: 3000,
    description:
      "Préparation traditionnelle béninoise, à base de maïs fermenté",
    image: akassa1,
    badge: "Signature",
  ...
  },
  {
    ...
    priceNum: 2500,
    description:
      "Sauces maison préparées avec des épices et ingrédients locaux",
    image: sauce1,
    badge: null,
        ...
        <div className="lg:w-1/2 p-4 sm:p-6 lg:p-8 flex flex-col justify-between">
          <div>
            ...
            <p className="text-chocolate-400 text-xs sm:text-sm leading-relaxed">
              Préparé chaque matin avec des ingrédients soigneusement
              sélectionnés pour vous offrir une expérience gustative
              incomparable. Disponible en boutique ou sur commande.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Reveal className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-chocolate-600 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed">
            Découvrez notre sélection de pâtisseries artisanales, préparées
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {filtered.map((product, i) => (
            <Reveal key={product.id} delay={i * 80}>
              <div className="group bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 h-full">
                {/* Image */}
